                            ...
                            for role in roles:
                                    ...
                                    try:
                                            ...
                                            if p:
                                                    ...
                                                    try:
                                                        response2 = self.iam.list_attached_role_policies(RoleName=role_name)
                                                        role["AttachedPolicies"].extend(response2.get("AttachedPolicies", []))

                                                    except ClientError as e:
                                                            print(f"[!] list_attached_policies failed:{e}")
