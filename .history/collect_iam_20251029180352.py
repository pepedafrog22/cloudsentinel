...
if __name__ == "__main__":
    ...
    parser.add_argument("--profile", help=help="AWS profile name to use (for live scan).", default=None)
    parser.add_argument("--demo", help="Path to demo/sample JSON to load instead of calling AWS.", )
