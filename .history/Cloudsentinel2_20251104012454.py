...
python cloudsentinel.py cloudsentinel --profile defender-readonly \
  --snapshot-out data/iam_snapshot.json --findings-out out/findings.json --report-out report.txt

# Full demo run (use canned snapshot) → prints/saves ASCII report
python cloudsentinel.py cloudsentinel --demo demo/sample_account.json --report-out report.txt
